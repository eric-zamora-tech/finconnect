...
const SideBar = ({ user }: SidebarProps) => {
    ...
    return (
        <section className="sidebar">
            <nav className="fex flex-col gap-4">
                <Link href="/"
                    className="flex mb-12 cursor-pointer items-center gap-2">
                    <Image alt="FinConnect Logo" className="size-[24px] max-xl:size-14" src="/icons/logo.svg" width={34} height={34} />
                    <h1 className="sidebar-logo">FinConnect</h1>
                </Link>
